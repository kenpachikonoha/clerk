...
const CartesianAxis = ({ tickCount = 5, tickValues, labelPosition = "outset", labelOffset = { x: 2, y: 4 }, axisSide = { x: "bottom", y: "left" }, lineColor = "hsla(0, 0%, 0%, 0.25)", lineWidth = react_native_1.StyleSheet.hairlineWidth, labelColor = "#000000", formatYLabel = (label) => String(label), formatXLabel = (label) => String(label), yScale, xScale, font, isNumericalData = false, ix = [], }) => {
    ...
    const axisConfiguration = (0, react_1.useMemo)(() => {
        return {
            ...
            xTickValues: Array.isArray(tickValues) ? tickValues : tickValues === null || tickValues === void 0 ? void 0 : tickValues.x,
            yTickValues: Array.isArray(tickValues) ? tickValues : tickValues === null || tickValues === void 0 ? void 0 : tickValues.y,
    ...
    const { xTicks, yTicks, xTickValues, yTickValues, xAxisPosition, yAxisPosition, xLabelPosition, yLabelPosition, xLabelOffset, yLabelOffset, gridXLineColor, gridYLineColor, gridFrameLineColor, gridXLineWidth, gridYLineWidth, gridFrameLineWidth, } = axisConfiguration;
    ...
    const yAxisNodes = yTicksNormalized.map((tick) => {
        ...
        const labelWidth = (_b = (_a = font === null || font === void 0 ? void 0 : font.getTextWidth) === null || _a === void 0 ? void 0 : _a.call(font, contentY)) !== null && _b !== void 0 ? _b : 0;
        ...
        <react_native_skia_1.Line p1={(0, react_native_skia_1.vec)(xScale(x1), yScale(tick))} p2={(0, react_native_skia_1.vec)(xScale(x2), yScale(tick))} color={gridYLineColor} strokeWidth={gridYLineWidth}/>
        {font
    ...
    const xAxisNodes = xTicksNormalized.map((tick) => {
        ...
        const labelWidth = (_b = (_a = font === null || font === void 0 ? void 0 : font.getTextWidth) === null || _a === void 0 ? void 0 : _a.call(font, contentX)) !== null && _b !== void 0 ? _b : 0;
        ...
        <react_native_skia_1.Line p1={(0, react_native_skia_1.vec)(xScale(tick), yScale(y2))} p2={(0, react_native_skia_1.vec)(xScale(tick), yScale(y1))} color={gridXLineColor} strokeWidth={gridXLineWidth}/>
